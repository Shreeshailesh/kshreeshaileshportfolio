...
import galOotyAsset from "@/assets/gal-ooty-v2.jpg.asset.json";
const galOoty = galOotyAsset.url;
import galGokarnaAsset from "@/assets/gal-gokarna-v2.jpg.asset.json";
const galGokarna = galGokarnaAsset.url;
